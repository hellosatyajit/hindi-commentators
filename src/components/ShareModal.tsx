...
import { trackShareAction, trackShareModalOpen } from '~/utils/analytics'
...
export function ShareModal({ isOpen, onClose }: ShareModalProps) {
    ...
    const socialLinks = [
        ...
        },
        {
            ...
            onClick: () => trackShareAction('whatsapp')
        }
    ]
...
export function useShareModal() {
    ...
    return {
        isModalOpen,
        openModal: (trigger: 'auto' | 'manual') => {
            setIsModalOpen(true)
            trackShareModalOpen(trigger)
        },
